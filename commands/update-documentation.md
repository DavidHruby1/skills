...
4. Check every report against the assigned diff and named sources. Use direct search and source reads to resolve unclear relationships. Ask the same subagent to correct incomplete or inconsistent findings. Completion: every report is accepted and every documentation-impacting change has a target document or an explicit reason no document applies.
